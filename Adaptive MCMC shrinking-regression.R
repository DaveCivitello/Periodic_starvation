...
solve.DEB.food<-function(params, inits, duration, feeding.events){
  ...
  Sup.6U <- lsoda(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                  params[1:25],  rtol=1e-6, atol=1e-6,   
  ...
  Sup.5 <- lsoda(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                 initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                 params[1:25],  rtol=1e-6, atol=1e-6,   
                 events = list(data = feed.sup))
  if(attributes(Sup.5)$istate[1] != 2)(return(Sup.6))
  Sup.5U <- lsoda(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                  params[1:25],  rtol=1e-6, atol=1e-6,   
                  events = list(data = feed.sup.U))
  ...
  Sup.4 <- lsoda(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                 initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                 params[1:25],  rtol=1e-6, atol=1e-6,   
                 events = list(data = feed.sup))  
  if(attributes(Sup.4)$istate[1] != 2)(return(Sup.6))
  Sup.4U <- lsoda(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                  params[1:25],  rtol=1e-6, atol=1e-6,   
                  events = list(data = feed.sup.U))
  ...
  Sup.3 <- lsoda(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                 initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                 params[1:25],  rtol=1e-6, atol=1e-6,   
                 events = list(data = feed.sup))
  if(attributes(Sup.3)$istate[1] != 2)(return(Sup.6))
  Sup.3U <- lsoda(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                  params[1:25],  rtol=1e-6, atol=1e-6,   
                  events = list(data = feed.sup.U))
  ...
  Sup.2 <- lsoda(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                  params[1:25],  rtol=1e-6, atol=1e-6,   
                  events = list(data = feed.sup))
  if(attributes(Sup.2)$istate[1] != 2)(return(Sup.6))
  Sup.2U <- lsoda(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                   initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                   params[1:25],  rtol=1e-6, atol=1e-6,   
                   events = list(data = feed.sup.U))
  ...
  Sup.1 <- lsoda(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                  params[1:25],  rtol=1e-6, atol=1e-6,   
                  events = list(data = feed.sup))
  if(attributes(Sup.1)$istate[1] != 2)(return(Sup.6))
  Sup.1U <- lsoda(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                   initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                   params[1:25],  rtol=1e-6, atol=1e-6,   
                   events = list(data = feed.sup.U))
...
solve.DEB.starve<-function(params, inits, duration){
  ...
  out_1_0 <- data.frame(ode(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
  ...
  out_1_0U <- ode(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), method="lsoda",
                  params[1:25],  rtol=1e-6, atol=1e-6, maxsteps=5e5,
  ...
  out_2_2 <- ode(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                 initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), method="lsoda",
                 params[1:25],  rtol=1e-6, atol=1e-6, maxsteps=5e5,
                 events = list(data = food_2_2))
  if(attributes(out_2_2)$istate[1] != 2)(return(out_1_0))
  out_2_2U <- ode(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), method="lsoda",
                  params[1:25],  rtol=1e-6, atol=1e-6, maxsteps=5e5,
  ...
  out_3_3 <- ode(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                 initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), method="lsoda",
                 params[1:25],  rtol=1e-6, atol=1e-6, maxsteps=5e5,
                 events = list(data = food_3_3))
  if(attributes(out_3_3)$istate[1] != 2)(return(out_1_0))
  out_3_3U <- ode(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), method="lsoda",
                  params[1:25],  rtol=1e-6, atol=1e-6, maxsteps=5e5,
  ...
  out_4_4 <- ode(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                 initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), method="lsoda",
                 params[1:25],  rtol=1e-6, atol=1e-6, maxsteps=5e5,
                 events = list(data = food_4_4))
  if(attributes(out_4_4)$istate[1] != 2)(return(out_1_0))
  out_4_4U <- ode(inits, 0:duration, func = "derivs", dllname = "IndividualModel_Shrink_P_dilute", 
                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), method="lsoda",
                  params[1:25],  rtol=1e-6, atol=1e-6, maxsteps=5e5,
...
make.states<-function(params, inits.R, inits.P, duration.F, duration.S, feeding.events.F, w.t=7){
  result.F = solve.DEB.food(params, inits.R, duration.F, feeding.events.F)
  ...
  result.S = solve.DEB.starve(params, inits.P, duration.S)
...
setwd("C:/RData")
samps = readRDS("Full_Fitting_Shrinking.Rda")
...
print(round(1 - rejectionRate(mcmc(testc)), 3))
plot(1:length(testc[,"lpost"]), testc[,"lpost"])
saveRDS(test, file="Full_Fitting_Shrinking.Rda")
